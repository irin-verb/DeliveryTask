...
Процедура ОтменитьНевзятыеЗаказы() 
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		ЗаказСсылка = ВыборкаДетальныеЗаписи.Заказ; 
		ОтменитьЗаказ(ЗаказСсылка);
	КонецЦикла;
КонецПроцедуры

Процедура ОтменитьЗаказ(Заказ) Экспорт 
	ЗаказОбъект = Заказ.ПолучитьОбъект();
	ЗаказОбъект.Состояние = Перечисления.СтадииДоставкиЗаказа.Отменен;
	ЗаказОбъект.Записать();	
КонецПроцедуры

Процедура ПредложитьЗаказОсновнымКурьерам(Заказ) Экспорт
...
Процедура ПредложитьЗаказГотовымКурьерамСПриоритетом(Заказ, Магазин) Экспорт
...
Процедура ПредложитьЗаказГотовымКурьерам(Заказ) Экспорт
